...
import com.example.jalil.bimarstan.Detail_take_leftActivity;
...
public class TakePriceLeftAdapter extends ArrayAdapter<dragestor> {

    private final Activity context;
    private final List<dragestor>  itemname;

    public TakePriceLeftAdapter(Activity context, List<dragestor> itemname) {
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        try {
            ...
            if (listItem == null) {
                ...
                listItem = LayoutInflater.from(context).inflate(R.layout.listpriceleft, parent, false);
            ...
            wrapper.getPayment().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent jalil=new Intent(MyApplication.activity,Detail_take_leftActivity.class);
                    jalil.putExtra("detail",itemname.get(position).getMobile2());
                    MyApplication.activity.startActivity(jalil);
                }
            });
